...
import AnimationLoyalty from "../components/animation";
      ...
      <AnimationLoyalty>
        ...
        >
          ...
          <p className={styles.paragraph}>
            ...
            <mark>
              React, Next.js, TypeScript, GraphQL, SQL, FIGMA UI design
            </mark>
          </p>
          <p>
            ...
            <b>
              user-friendly, accessible, fast, responsive, reliable, dynamic{" "}
            </b>
            , and built with modern technology.
          </p>
          <div style={{ paddingBottom: 20 }} />
          <p>
            I am originally from Ukraine, living in Vancouver, BC, Canada. I
            legal authorized to work in Canada (no visa sponsorship required).
            🇨🇦
          </p>
        </Section>
      </AnimationLoyalty>
      <AnimationLoyalty>
        <Section title="My Biggest Passion" subtitle="Making businesses better">
          ...
          <p>
            ...
            2019, because I am eager and really good at logical structuring on
            the client side and creating reusable, scalable, safe, and reliable
          ...
          <p>
            ...
            Development. But now, it's in a way where I'm more about
            collaborating with businesses and having an impact, with a strong
            focus on business, strategy, value, and missions.
          </p>
        </Section>
      </AnimationLoyalty>
      <Section
